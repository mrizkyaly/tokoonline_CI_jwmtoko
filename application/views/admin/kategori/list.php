	...
	<tbody>
		...
		<tr>
			...
			<td>
				...
				<a href="<?php echo base_url('admin/kategori/delete/' .$kategori->id_kategori) ?>" class="btn btn-danger btn-xs" onclick="return confirm('Yakin Menghapus data ini ?')"><i class="fa fa-trash"></i> Delete</a>
			</td>
		</tr>
		<?php $no++; } ?> 
	</tbody>
